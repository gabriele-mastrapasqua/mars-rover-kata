...
type Action = {type: 'reset'} | {type: 'parse', input: string} | {type: 'nextCommands', commandSequence: CommandSequence}
type Dispatch = (action: Action) => void
type GameProviderProps = {children: React.ReactNode}


export const GameContext = React.createContext<{state: GameState; dispatch: Dispatch} | undefined>(undefined)
